...
export default function Datagrid() {
  ...
  const TableData = async () => {
    try {
      const data = await axios.get(
        "http://localhost:8080/HighradiusProject/Winter"
      );
  ...
  const handleClick = (event, sl_no) => {
    ...
    console.log(localStorage.getItem("sl_no"));
    if (selectedIndex === -1) {
    ...
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        <TableContainer sx={{ height: 400 }}>
          <Table
            sx={{ height: 400, minWidth: 750, backgroundColor: "#283D4A" }}
          >
            <EnhancedTableHead
                ...
                .map((rows, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <StyledTableCell align="right">
                        {rows.document_create_date}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.document_create_date1}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.due_in_date}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.invoice_currency}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.document_type}
                      </StyledTableCell>
                      ...
                      <StyledTableCell align="right">
                        {rows.total_open_amount}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.baseline_create_date}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.cust_payment_terms}
                      </StyledTableCell>
                      <StyledTableCell align="right">
                        {rows.invoice_id}
                      </StyledTableCell>
        ...
        <Table sx={{ minWidth: 750, backgroundColor: "#283D4A" }}>
          <TablePagination
